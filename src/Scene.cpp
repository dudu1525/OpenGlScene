...
void gps::Scene::changeNightDayDirLight(GLuint programId)
{
	if (dayTime)
	{
		dayTime = false;
	...
	lightSources.setLightUniforms(programId);
...
void gps::Scene::renderLights(Shader lightsshader, glm::mat4 view)
{
	...
	{
		glm::mat4 sunModel = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 2.0f, -2.0f));
